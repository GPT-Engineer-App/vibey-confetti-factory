...
**Project**: vibey-confetti-factory 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a fun vibes confetti app 
...
```sh
git clone https://github.com/GPT-Engineer-App/vibey-confetti-factory.git
cd vibey-confetti-factory
npm i
